            ...
            def get_sort_key(comment):
                ...
                if filter_type == "comment_extremity":
                    ...
                    total_engagement = (
                        ...
                        if isinstance(agrees, (int, float)) and isinstance(disagrees, (int, float))
                        else 0
                    )
                    ...
                    if "params" in debug_request:
                        ...
                        if (
                            ...
                            debug_request["params"]["system"] = (
                                debug_request["params"]["system"][:100] + "... [content truncated for log]"
                            )
                                ...
                                if "content" in msg and isinstance(msg["content"], list):
                                    for content_item in msg["content"]:
                                        if (
                                            ...
                                            content_item["text"] = (
                                                content_item["text"][:100] + "... [content truncated for log]"
                                            )
