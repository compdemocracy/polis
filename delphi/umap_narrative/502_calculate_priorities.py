#!/usr/bin/env python3
"""Thin CLI shim -> stages.comment_priorities.

The stage logic now lives in ``umap_narrative/stages/comment_priorities.py`` so
...
command line, exactly as before:
    ...
    python umap_narrative/502_calculate_priorities.py --conversation_id=<ID>
"""
import os
import sys
