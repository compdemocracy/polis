...
class TestConversation:
    ...
    def test_text_vote_values(self):
        ...
        assert (
            "p2" not in updated_conv.raw_rating_mat.rownames()
            or "c1" not in updated_conv.raw_rating_mat.colnames()
            or pd.isna(updated_conv.raw_rating_mat.matrix.loc["p2", "c1"])
        )
    ...
    def test_moderation(self):
        ...
        # Apply moderation
        moderation = {"mod_out_tids": ["c2"], "mod_out_ptpts": ["p3"]}
    ...
    def test_recompute(self):
        ...
        try:
            ...
            for group_id in group_ids:
                assert (
                    str(group_id) in computed_conv.repness["group_repness"]
                    or group_id in computed_conv.repness["group_repness"]
                )
        except KeyError:
...
class TestConversationManager:
    ...
    def test_process_votes(self):
        ...
        # Create votes
        votes = {"votes": [{"pid": "p1", "tid": "c1", "vote": 1}, {"pid": "p2", "tid": "c1", "vote": -1}]}
