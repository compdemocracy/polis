...
class TestCommentStats:
    ...
    def test_add_comparative_stats(self):
        ...
        group_stats = {"na": 8, "nd": 2, "ns": 10, "pa": 0.8, "pd": 0.2, "pat": 3.0, "pdt": -3.0}

        # Other group stats: 40% agree
        other_stats = {"na": 4, "nd": 6, "ns": 10, "pa": 0.4, "pd": 0.6, "pat": -1.0, "pdt": 1.0}
        ...
        other_stats_zero = {"na": 0, "nd": 10, "ns": 10, "pa": 0.0, "pd": 1.0, "pat": -5.0, "pdt": 5.0}
    ...
    def test_repness_metric(self):
        ...
        stats = {"pa": 0.8, "pd": 0.2, "pat": 3.0, "pdt": -3.0, "ra": 2.0, "rd": 0.33, "rat": 2.5, "rdt": -2.5}
    ...
    def test_finalize_cmt_stats(self):
        ...
        agree_stats = {"pa": 0.8, "pd": 0.2, "pat": 3.0, "pdt": -3.0, "ra": 2.0, "rd": 0.33, "rat": 2.5, "rdt": -2.5}
        ...
        disagree_stats = {"pa": 0.2, "pd": 0.8, "pat": -3.0, "pdt": 3.0, "ra": 0.33, "rd": 2.0, "rat": -2.5, "rdt": 2.5}
...
class TestSelectionFunctions:
    ...
    def test_passes_by_test(self):
        ...
        passing_stats = {"pa": 0.8, "pd": 0.2, "pat": 3.0, "pdt": -3.0, "ra": 2.0, "rd": 0.33, "rat": 3.0, "rdt": -3.0}
...
class TestConsensusAndGroupRepness:
    ...
    def test_select_consensus_comments(self):
        ...
        group1_stats = [
            {"comment_id": "c1", "group_id": 1, "pa": 0.8, "pd": 0.2},
            {"comment_id": "c2", "group_id": 1, "pa": 0.7, "pd": 0.3},
        ]

        group2_stats = [
            {"comment_id": "c1", "group_id": 2, "pa": 0.85, "pd": 0.15},
            {"comment_id": "c2", "group_id": 2, "pa": 0.6, "pd": 0.4},
            {"comment_id": "c3", "group_id": 2, "pa": 0.9, "pd": 0.1},
        ]
...
class TestIntegration:
    ...
    def test_participant_stats(self):
        ...
        # Create group clusters
        group_clusters = [{"id": 1, "members": ["p1", "p2"]}, {"id": 2, "members": ["p3", "p4"]}]
