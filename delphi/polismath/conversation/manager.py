...
class ConversationManager:
    ...
    def create_conversation(self, conversation_id: str, votes: dict[str, Any] | None = None) -> Conversation:
        """
    ...
    def process_votes(self, conversation_id: str, votes: dict[str, Any]) -> Conversation:
        """
    ...
    def update_moderation(self, conversation_id: str, moderation: dict[str, Any]) -> Conversation | None:
        """
    ...
    def recompute(self, conversation_id: str) -> Conversation | None:
        """
    ...
    def export_conversation(self, conversation_id: str, filepath: str) -> bool:
        """
    ...
    def import_conversation(self, filepath: str) -> str | None:
        """
        ...
        try:
            ...
            # Ensure conv_id is always a string
            conv_id = str(conv_id_raw)
    ...
    def import_conversation_from_data(self, conversation_id: str, data: dict[str, Any]) -> str | None:
        """
        Import a conversation from data dictionary.
        ...
        try:
            ...
            logger.error(f"Error importing conversation from data: {e}")
            return None
