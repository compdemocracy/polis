        ...
        config["poller"]["vote-interval"] = (
            to_float(
                os.environ.get(
                    ...
                    to_float(os.environ.get("POLL_INTERVAL_MS", config["poller"]["vote-interval"] * 1000)),
                )
            )
            / 1000.0
        )
        config["poller"]["mod-interval"] = (
            to_float(
                os.environ.get(
                    ...
                    to_float(os.environ.get("POLL_INTERVAL_MS", config["poller"]["mod-interval"] * 1000)),
                )
            )
            / 1000.0
        )
        config["poller"]["task-interval"] = (
            to_float(
                os.environ.get(
                    ...
                    to_float(os.environ.get("POLL_INTERVAL_MS", config["poller"]["task-interval"] * 1000)),
                )
            )
            / 1000.0
        )
