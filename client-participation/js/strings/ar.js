...
s.noCommentsYetSoInvite = "يمكنك بدء هذه المحادثة بدعوة المزيد من المشاركين، أو إضافة عبارة.";
s.noCommentsYouVotedOnAll = "لقد صوَّت على جميع العبارات.";
s.noCommentsTryWritingOne = "يمكنك إضافة معلومة بكتابة عبارتك.";
...
s.participantHelpGroupsText =
  "تتم الإشارة إليك باستخدام الدائرة الزرقاء ويتم تجميعك مع الأشخاص الذين يشاركونك وجهة النظر نفسها.";
s.participantHelpGroupsNotYetText = "سيظهر العرض المرئي بعد أن يبدأ 7 مشاركين التصويت";
...
s.helpWhatDoIDo = `يمكنك التصويت على عبارات الآخرين بالنقر على "أوافق" أو "لا أوافق"، وكتابة عبارة (فكرة واحدة في كل عبارة)، ودعوة أصدقائك إلى المحادثة.`;
...
s.tipOneIdea = "يُرجى الفصل بين العبارات الطويلة التي تتضمن عدة أفكار. سيسهِّل ذلك على الآخرين التصويت على عباراتك.";
s.tipNoQuestions = "يجب ألا تكون العبارات على شكل سؤال. فدور المشاركين أن يوافقوا أو لا يوافقوا على عباراتك.";
s.commentTooLongByChars = "تجاوزت العبارة الحد الأقصى لعدد الأحرف المسموح به بمقدار {{CHARACTERS_COUNT}} حرف.";
...
s.commentSendFailedEmpty = "حدث خطأ أثناء إرسال عبارتك، لأنّها فارغة.";
s.commentSendFailedTooLong = "حدث خطأ أثناء إرسال عبارتك، لأنّها طويلة جدًا.";
s.commentSendFailedDuplicate = "حدث خطأ أثناء إرسال عبارتك، لأنّه سبق إرسال أخرى طبق الأصل منها.";
...
s.notificationsEnterEmail = "يُرجى إدخال عنوان بريدك الإلكتروني لتلقّي إشعارات عند إضافة مزيد من العبارات:";
...
s.topic_good_01_reason = "سؤال بإجابة مفتوحة، ويمكن للجميع إبداء آرائهم بشأن الإجابة عنه";
s.topic_good_02 = "ما رأيك في الاقتراح الجديد؟";
s.topic_good_02_reason = "سؤال بإجابة مفتوحة، ويمكن للجميع إبداء آرائهم بشأن الإجابة عنه";
s.topic_good_03 = "هل يمكنك ذكر أسباب بُطء الإنتاجية؟";

s.topic_bad_01 = "أعلن الجميع استعدادهم لعملية الإطلاق";
s.topic_bad_01_reason = "سيصوِّت أفراد من فرق مختلفة على الردود، ولكن قد لا يكون لديهم المعرفة الكافية للتصويت بثقة.";
