...
s.helpWhatAmISeeing =
  "افرادی که به صورت مشابه رای میدهند در یک گروه قرار میگیرند. روی یکه گروه کلیک کنید تا ببینید چه دیدگاه های مشترکی دارند.";
s.helpWhatDoIDoTitle = "چه کار باید بکنم؟";
s.helpWhatDoIDo =
  "با کلیک روی 'موافق' و 'مخالف' به گفته دیگران رای دهید. نظرات خود را اضافه کنید. (هر ثبت نظر را به یک ایده محدود کنید.) دوستان خود را به گفتگو دعوت کنید.";
...
s.tipOneIdea =
  "جملات طولانی که حاوی چندین ایده هستند را جدا کنید. این کار رای دادن به گفته شما را برای دیگران آسان تر می کند:";
...
s.participantHelpGroupsText =
  "افرادی که به طور مشابه رای می‌دهند با هم گروه‌بندی می‌شوند. روی هر گروه کلیک کنید تا ببینید چه دیدگاه‌هایی را به اشتراک می‌گذارند. ...بیشتر";
...
s.topic_bad_01_reason =
  "افراد از تیم‌های مختلف در مورد نظرات رای میدهند، ولی ممکن است به اندازه کافی دانش نداشته باشند که با اطمینان رای دهند.";
