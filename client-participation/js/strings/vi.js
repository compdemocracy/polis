...
s.noCommentsYetSoInvite = "Để bắt đầu thảo luận, hãy phát biểu ý kiến hoặc mời thêm người tham gia.";
s.noCommentsYouVotedOnAll = "Bạn đã bình chọn cho tất cả ý kiến.";
s.noCommentsTryWritingOne = "Nếu có gì muốn bổ sung, hãy thử viết ý kiến của riêng bạn.";
...
s.pctAgreedOfGroupLong = "{{pct}}% số người thuộc nhóm {{group}} và bình chọn cho ý kiến {{comment_id}} đồng ý.";
...
s.participantHelpGroupsText =
  "Vòng tròn màu xanh dương đại diện cho bạn. Bạn ở chung nhóm với những người khác có cùng quan điểm.";
s.participantHelpGroupsNotYetText = "Hình ảnh trực quan sẽ xuất hiện sau khi có 7 người tham gia bắt đầu bình chọn";
...
s.helpWhatDoIDo = `Bạn có thể bình chọn cho ý kiến của người khác bằng cách nhấp vào "đồng ý" hoặc "không đồng ý". Bạn cũng có thể viết ý kiến (mỗi câu chỉ nêu một ý). Nhớ mời bạn bè cùng tham gia thảo luận nhé!`;
...
s.tipOneIdea = "Hãy chia nhỏ những câu dài chứa nhiều ý để giúp mọi người bình chọn cho ý kiến của bạn dễ dàng hơn.";
s.tipNoQuestions = "Đừng viết ý kiến dưới dạng câu hỏi. Người tham gia sẽ đồng ý hoặc không đồng ý với ý kiến của bạn.";
s.commentTooLongByChars = "Ý kiến vượt quá {{CHARACTERS_COUNT}} ký tự so với giới hạn.";
s.submitComment = "Gửi";
s.commentSent =
...
s.commentSendFailedEmpty = "Đã xảy ra lỗi khi gửi ý kiến của bạn – Ý kiến phải có nội dung.";
s.commentSendFailedTooLong = "Đã xảy ra lỗi khi gửi ý kiến của bạn – Ý kiến quá dài.";
s.commentSendFailedDuplicate = "Đã xảy ra lỗi khi gửi ý kiến của bạn – Đã có một ý kiến giống hệt như vậy.";
s.commentErrorDuplicate = "Trùng lặp! Ý kiến đó đã có từ trước.";
s.commentErrorConversationClosed = "Cuộc thảo luận này đã kết thúc. Bạn không gửi thêm ý kiến được nữa.";
...
s.topic_good_01_reason = "Đây là câu hỏi mở, nên ai cũng có thể có quan điểm riêng về câu trả lời cho câu hỏi này";
s.topic_good_02 = "Bạn thấy đề xuất mới như thế nào?";
s.topic_good_02_reason = "Đây là câu hỏi mở, nên ai cũng có thể có quan điểm riêng về câu trả lời cho câu hỏi này";
