...
s.helpWhatAmISeeing =
  "Пользователи, которые голосуют похоже, объединены в группы. Нажмите на группу, чтобы посмотреть какие мнения их объединяют.";
s.helpWhatDoIDoTitle = " Что здесь нужно делать?";
s.helpWhatDoIDo =
  "Голосуйте за комментарии других людей, нажимая 'согласен' или 'не согласен'. Напишите комментарий с одной идеей или мыслью. Пригласите друзей поучаствовать в диалоге!";
...
s.commentSendFailedDuplicate =
  "Произошла ошибка при отправке вашего комментария - Одинаковый комментарий уже существует.";
...
s.tipOneIdea =
  "Разбивайте длинные комментарии с несколькими мыслями. Другим пользователям будет проще голосовать за ваш комментарий.";
s.tipNoQuestions =
  "Комментарии не должны задавать вопрос. Участники соглашаются или не соглашаются с каждым комментарием.";
...
s.participantHelpGroupsText =
  "Люди, которые похоже голосуют <span style='font-weight: 700;'>выделяются в группы.</span> Нажмите на группу, чтобы увидеть какие мнения их объединяют. <a style='font-weight: 700; cursor: pointer; text-decoration: underline' id='helpTextGroupsExpand'>...больше</a>";
