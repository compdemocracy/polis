...
s.noCommentsYetSoInvite = "Započnite ovaj razgovor pozivanjem više učesnika ili dodajte izjavu.";
s.noCommentsYouVotedOnAll = "Glasali ste o svim izjavama.";
s.noCommentsTryWritingOne = "Ako želite nešto dodati, pokušajte napisati vlastitu izjavu.";
...
s.helpWhatAmISeeing = "Vas predstavlja plavi krug i u grupi ste s ostalima koji imaju isto mišljenje.";
...
s.pctAgreedOfGroupLong = "{{pct}}% se slaže iz grupe {{group}} koji su glasali o izjavi {{comment_id}}.";
s.pctDisagreedOfGroupLong = "{{pct}}% se ne slaže iz grupe {{group}} koji su glasali o izjavi {{comment_id}}.";
s.participantHelpGroupsText = "Vas predstavlja plavi krug i u grupi ste s ostalima koji imaju isto mišljenje.";
s.participantHelpGroupsNotYetText = "Vizuelizacija će se prikazati kada 7 učesnika počne glasati";
...
s.helpWhatDoIDo = `Glasajte o izjavama drugih osoba klikom na "Slažem se" ili "Ne slažem se"". Napišite izjavu (neka se svaka izjava odnosi na po jednu ideju). Pozovite prijatelje u razgovor!`;
...
s.tipOneIdea = "Podijelite duge izjave u kojima obrađujete više ideja. Ovo drugima olakšava da glasaju o vašoj izjavi.";
s.tipNoQuestions = "Izjave ne smiju biti u obliku pitanja. Učesnici će se s vašim izjavama složiti ili neće.";
s.commentTooLongByChars = "Ograničenje dužine izjave je premašeno za ovoliko znakova: {{CHARACTERS_COUNT}}.";
...
s.commentSendFailedEmpty = "Došlo je do greške prilikom slanja izjave – izjava ne smije biti prazna.";
s.commentSendFailedTooLong = "Došlo je do greške prilikom slanja izjave – izjava je preduga.";
s.commentSendFailedDuplicate = "Došlo je do greške prilikom slanja izjave – već postoji identična izjava.";
...
s.notificationsEnterEmail = "Unesite adresu e-pošte da dobijate obavještenja kada stignu dodatne izjave:";
...
s.topic_good_01_reason = "otvoreno; svako može poslati mišljenje o odgovorima na ovo pitanje";
s.topic_good_02 = "Šta mislite o novom prijedlogu?";
s.topic_good_02_reason = "otvoreno; svako može poslati mišljenje o odgovorima na ovo pitanje";
