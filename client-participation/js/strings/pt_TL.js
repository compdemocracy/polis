...
s.helpWhatAmISeeing =
  "Pessoas que votam de forma semelhante são agrupadas. Clique num grupo para ver quais pontos de vista que eles compartilham.";
s.helpWhatDoIDoTitle = "O que é que eu faço?";
s.helpWhatDoIDo =
  "Vote nas declarações de outras pessoas ao clicar em 'concordo' ou 'discordo'. Escreva uma declaração (mantenha cada uma delas com uma única ideia). Convide os seus amigos para a conversa! ";
