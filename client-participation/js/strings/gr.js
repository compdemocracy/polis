...
s.helpWhatAmISeeing =
  "Τα άτομα που ψηφίζουν παρόμοια ομαδοποιούνται. Κάντε κλικ σε μια ομάδα για να δείτε ποιες ιδέες μοιράζονται.";
s.helpWhatDoIDoTitle = " Τί να κάνω;";
s.helpWhatDoIDo =
  "Ψηφίστε τις ιδέες άλλων ατόμων πατώντας 'συμφωνώ' ή 'διαφωνώ'. Γράψτε μία ιδέα (καλύτερα για ένα θέμα μόνο). Προσκαλέστε τους φίλους σας στη συνομιλία!";
...
s.tipOneIdea =
  "Χωρίστε τις μεγάλες ιδέες που περιέχουν πολλά θέματα. Αυτό διευκολύνει τους άλλους να ψηφίσουν την ιδέα σας.";
s.tipNoQuestions =
  "Οι ιδέες δεν πρέπει να έχουν την μορφή ερώτησης. Οι συμμετέχοντες θα συμφωνήσουν ή θα διαφωνήσουν με τις ιδέες που θα υποβάλετε.";
...
s.participantHelpGroupsText =
  "Άτομα που ψηφίζουν παρόμοια <span style='font-weight: 700;'>ομαδοποιούνται.</span> Πατήστε σε μία ομάδα για να δείτε ποιες απόψεις μοιράζονται. <a style='font-weight: 700; cursor: pointer; text-decoration: underline' id='helpTextGroupsExpand'>...περισσότερα</a>";
...
s.topic_bad_01_reason =
  "άτομα από διάφορες ομάδες θα ψηφίσουν για τις απαντήσεις, αλλά μπορεί να μην έχουν αρκετές γνώσεις για να ψηφίσουν με αυτοπεποίθηση.";
