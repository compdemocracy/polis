...
s.x_tweeted = "tuítou:";
s.group_123 = "Grupo:";
s.majorityOpinion = "Opinião Majoritária";
s.majorityOpinionShort = "Majoritária";
s.info = "Info";
s.addPolisToYourSite = "<img style='height: 20px; margin: 0px 4px;' src='{{URL}}'/>";
s.privacy = "Privacidade";
s.TOS = "Termos de uso";
s.writePrompt = "Inclua seu ponto de vista...";
s.anonPerson = "Anônimo";
s.helpWhatAmISeeingTitle = "O que estou vendo?";
s.helpWhatAmISeeing = "Pessoas que reagiram aos comentários de forma parecida estão agrupadas. Clique num grupo pra ver as opiniões que elas compartilham.";
s.helpWhatDoIDoTitle = " Que faço?";
s.helpWhatDoIDo = "Reaja aos comentários das outras pessoas clicando em 'concordo' ou 'discordo'. Escreva comentários (um para cada ideia). Chame os amigos para a discussão!";
s.writeCommentHelpText = "Se o seu ponto de vista não está representado ainda, <strong>escreva</strong> um comentário!</i>";
...
s.participantHelpWelcomeText = "Bem vindo a um novo jeito de discutir - <span style='font-weight: 700;'>reaja</span> às opiniões das pessoas e <span style='font-weight: 700;'>contribua</span> com a sua.";
...
s.helpWhatAreGroupsDetail = "<p>Você provavelmente já observou aquelas listas de 'produtos recomendados' pelos sites de compras ou os 'filmes recomendados' pela Netflix. Cada um desses serviços utiliza estatísticas para agrupar você junto com pessoas que compram e assistem coisas parecidas, pra então te mostrar as coisas que essas pessoas compraram ou assistiram.</p> <p> Quando você reage a um comentário, você é agrupado com pessoas que reagiram de um jeito parecido contigo! Você pode ver esses grupos abaixo. Cada um é formado por pessoas que tem opiniões parecidas. Há ideias fascinantes para descobrir em cada conversa. Vá em frente - clique num grupo para ver o que os uniu e o que faz eles serem únicos! </p>";
s.socialConnectPrompt = "Conecte visualizar os amigos e pessoas que você segue.";
...
s.noCommentsYouVotedOnAll = "Você já votou em todos os comentários.";
