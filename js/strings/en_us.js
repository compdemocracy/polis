...
s.writeCommentHelpText = "If your perspective isn't already represented, <em>submit</em> a statement!</i>";
...
s.tipCommentsRandom = "Statements are displayed randomly. You are not directly replying to anyone.";
...
s.helpWhatAreGroupsDetail = "<p>You've probably seen 'recommended products' on Amazon, or 'recommended movies' on Netflix. Each of those services uses statistics to group the user with people who buy and watch similar things, then show them things that those people bought or watched.</p> <p> When a vote is cast on a statement, it is are grouped with people who voted like they did! You can see those groups below. Each is made up of people who have similar opinions. There are fascinating insights to discover in each conversation. Go ahead - click a group to see what brought them together and what makes them unique! </p>";
