...
-- ⚠️ KEEP IN SYNC: server/docs/data-model.md is the developer orientation doc for this
-- schema. If you add/rename/drop a core table or change a documented convention
-- (per-conversation tid/pid triggers, epoch-millis timestamps, the raw vote-sign inversion,
-- vis_type, etc.), update that doc in the SAME PR — code and doc drift apart otherwise.
