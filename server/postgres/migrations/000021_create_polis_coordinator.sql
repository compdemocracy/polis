...
('table','math_main','','polis_coordinator_observer','SELECT'),
('table','math_ticks','','polis_coordinator_observer','SELECT'),
('table','math_bidtopid','','polis_coordinator_observer','SELECT'),
('table','math_ptptstats','','polis_coordinator_observer','SELECT'),
