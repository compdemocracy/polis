...
export default {
  polis_err_param_parse_failed_email:
  ...
  polis_err_login_unknown_user_or_password_noresults:
    'Login falhou: usuário/senha inválida.',
  ...
  share_but_no_visible_comments_warning:
    'Essa discussão não tem comentários visíveis. Nós recomendamos acrescentar alguns comentários ou moderar comentários que estejam na fila antes de convidar os participantes, já que isso os ajudará a entender que tipo de comentários eles devem enviar.'
}
