...
class News extends React.Component {
  ...
  render() {
    return (
      <Flex
        styleOverrides={this.styles().flexTestContainer}
        direction={'column'}
...
export default News;
      ...
      //         <p style={this.styles().heroSub}>{'Turn your site into a center of gravity for conversations around the issues your audience respects you for the most.'} </p>
      //     </Flex>
      //     {/* upper cta */}
      ...
      //         <p style={this.styles().sectionHeader}> {'Take the Power Back From Social Media'} </p>
      //         <p style={this.styles().subheading}> { "You produce the content, and you should benefit from the dialogue around it. You care deeply about the places and issues you cover, and are qualified to moderate constructive dialogue. Pol.is can help you centralize and highlight discussions of critical issues on your site, away from the echo chamber of Twitter and Facebook." } </p>
      //       </Flex>
      //       <Flex styleOverrides={this.styles().section} direction='column' alignItems={'flex-start'}>
      //         <p style={this.styles().sectionHeader}> {'Scale Up Engagement'} </p>
      //         <p style={this.styles().subheading}> { "Your audience could fill stadiums. Shouldn't your comment threads accomodate more than a cocktail party? Polis engages a much larger percentage of your audience, and stays interesting regardless of how many people want to engage - even if that's hundreds of thousands." } </p>
      //       </Flex>
      //       <Flex styleOverrides={this.styles().section} direction='column' alignItems={'flex-start'}>
      //         <p style={this.styles().sectionHeader}> {'Delight Your Brightest, Busiest Readers'} </p>
      //         <p style={this.styles().subheading}> { "Give your most social media savvy participants an incentive to share their thoughts on your site. Pol.is engages your best readers by showing them how they compare to others, and gets them noticed if they have a high follower count." } </p>
      //       </Flex>
      //       <Flex styleOverrides={this.styles().section} direction='column' alignItems={'flex-start'}>
